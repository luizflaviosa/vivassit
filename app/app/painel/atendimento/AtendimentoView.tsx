...
export default function AtendimentoView({ chatwootUrl }: AtendimentoViewProps) {
  const router = useRouter();

  // Event listener customizado pra focus externo (mantido inalterado da versao
  // anterior — outros components podem disparar 'singulare:atendimento-focus').
  useEffect(() => {
    const handler = () => {};
