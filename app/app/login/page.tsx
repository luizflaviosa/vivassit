...
import { Mail, ArrowRight, Loader2, Check, ShieldCheck } from 'lucide-react';
        ...
        >
          {magicSent ? (
            ...
            <>
              ...
              <form onSubmit={handleMagicLink} className="px-8 pb-6 space-y-3">
                ...
                >
                  {submitting ? (
                    ...
                    <>Receber link por email<ArrowRight className="w-4 h-4" /></>
                  )}
                </button>
                <p className="text-[12px] text-zinc-500 leading-relaxed text-center pt-1">
                  Sem senhas. Cada acesso chega no seu email.
                </p>
              </form>
